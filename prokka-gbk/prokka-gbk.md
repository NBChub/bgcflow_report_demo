...
<table id="itables_4ce8e897_e12c_4d0e_82a6_96f259ac92b9" class="display compact" data-quarto-disable-processing="true" style="table-layout:auto;width:auto;margin:auto;caption-side:bottom">
<thead>
...
<script type="module">
    ...
    $(document).ready(function () {
        document.querySelectorAll("#itables_4ce8e897_e12c_4d0e_82a6_96f259ac92b9:not(.dataTable)").forEach(table => {
...
<style>
  #altair-viz-546bc5ea66b54588bd7b7a8483ed04fa.vega-embed {
    width: 100%;
    display: flex;
  }

  #altair-viz-546bc5ea66b54588bd7b7a8483ed04fa.vega-embed details,
  #altair-viz-546bc5ea66b54588bd7b7a8483ed04fa.vega-embed details summary {
    position: relative;
  }
</style>
<div id="altair-viz-546bc5ea66b54588bd7b7a8483ed04fa"></div>
<script type="text/javascript">
  var VEGA_DEBUG = (typeof VEGA_DEBUG == "undefined") ? {} : VEGA_DEBUG;
  (function(spec, embedOpt){
    let outputDiv = document.currentScript.previousElementSibling;
    if (outputDiv.id !== "altair-viz-546bc5ea66b54588bd7b7a8483ed04fa") {
      outputDiv = document.getElementById("altair-viz-546bc5ea66b54588bd7b7a8483ed04fa");
    }
    const paths = {
