...
<table id="itables_dab00e01_2758_4f16_aa89_7f00f2a4aff7" class="display compact" data-quarto-disable-processing="true" style="table-layout:auto;width:auto;margin:auto;caption-side:bottom">
<thead>
...
<script type="module">
    ...
    $(document).ready(function () {
        document.querySelectorAll("#itables_dab00e01_2758_4f16_aa89_7f00f2a4aff7:not(.dataTable)").forEach(table => {
...
<style>
  #altair-viz-4820bcb5841e45eebc95ec7aeaa91539.vega-embed {
    width: 100%;
    display: flex;
  }

  #altair-viz-4820bcb5841e45eebc95ec7aeaa91539.vega-embed details,
  #altair-viz-4820bcb5841e45eebc95ec7aeaa91539.vega-embed details summary {
    position: relative;
  }
</style>
<div id="altair-viz-4820bcb5841e45eebc95ec7aeaa91539"></div>
<script type="text/javascript">
  var VEGA_DEBUG = (typeof VEGA_DEBUG == "undefined") ? {} : VEGA_DEBUG;
  (function(spec, embedOpt){
    let outputDiv = document.currentScript.previousElementSibling;
    if (outputDiv.id !== "altair-viz-4820bcb5841e45eebc95ec7aeaa91539") {
      outputDiv = document.getElementById("altair-viz-4820bcb5841e45eebc95ec7aeaa91539");
    }
    const paths = {
