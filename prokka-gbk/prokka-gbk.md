...
<table id="itables_97284513_e703_4e9a_b1af_e5fcd29d14eb" class="display compact" data-quarto-disable-processing="true" style="table-layout:auto;width:auto;margin:auto;caption-side:bottom">
<thead>
...
<script type="module">
    ...
    $(document).ready(function () {
        document.querySelectorAll("#itables_97284513_e703_4e9a_b1af_e5fcd29d14eb:not(.dataTable)").forEach(table => {
...
<style>
  #altair-viz-5e35ab9f440c4ded898233ff6667cc36.vega-embed {
    width: 100%;
    display: flex;
  }

  #altair-viz-5e35ab9f440c4ded898233ff6667cc36.vega-embed details,
  #altair-viz-5e35ab9f440c4ded898233ff6667cc36.vega-embed details summary {
    position: relative;
  }
</style>
<div id="altair-viz-5e35ab9f440c4ded898233ff6667cc36"></div>
<script type="text/javascript">
  var VEGA_DEBUG = (typeof VEGA_DEBUG == "undefined") ? {} : VEGA_DEBUG;
  (function(spec, embedOpt){
    let outputDiv = document.currentScript.previousElementSibling;
    if (outputDiv.id !== "altair-viz-5e35ab9f440c4ded898233ff6667cc36") {
      outputDiv = document.getElementById("altair-viz-5e35ab9f440c4ded898233ff6667cc36");
    }
    const paths = {
