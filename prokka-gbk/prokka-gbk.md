...
<table id="itables_62917506_a34d_41cf_87d0_1b3c7f98871d" class="display compact" data-quarto-disable-processing="true" style="table-layout:auto;width:auto;margin:auto;caption-side:bottom">
<thead>
...
<script type="module">
    ...
    $(document).ready(function () {
        document.querySelectorAll("#itables_62917506_a34d_41cf_87d0_1b3c7f98871d:not(.dataTable)").forEach(table => {
...
<style>
  #altair-viz-e8e7c456a3fc4836aba7766ab7208f84.vega-embed {
    width: 100%;
    display: flex;
  }

  #altair-viz-e8e7c456a3fc4836aba7766ab7208f84.vega-embed details,
  #altair-viz-e8e7c456a3fc4836aba7766ab7208f84.vega-embed details summary {
    position: relative;
  }
</style>
<div id="altair-viz-e8e7c456a3fc4836aba7766ab7208f84"></div>
<script type="text/javascript">
  var VEGA_DEBUG = (typeof VEGA_DEBUG == "undefined") ? {} : VEGA_DEBUG;
  (function(spec, embedOpt){
    let outputDiv = document.currentScript.previousElementSibling;
    if (outputDiv.id !== "altair-viz-e8e7c456a3fc4836aba7766ab7208f84") {
      outputDiv = document.getElementById("altair-viz-e8e7c456a3fc4836aba7766ab7208f84");
    }
    const paths = {
