...
<table id="itables_1c116e9c_d83f_43b9_84ca_eeeb43fa98d2" class="display compact" data-quarto-disable-processing="true" style="table-layout:auto;width:auto;margin:auto;caption-side:bottom">
<thead>
...
<script type="module">
    ...
    $(document).ready(function () {
        document.querySelectorAll("#itables_1c116e9c_d83f_43b9_84ca_eeeb43fa98d2:not(.dataTable)").forEach(table => {
...
<a href="../assets/iTOL_annotation/iTOL_antismash_7.0.0_completeness.txt" download class="md-button">Download antiSMASH barchart</a> <a href="../assets/iTOL_annotation/iTOL_BiG-SCAPE_class_antismash_7.0.0.txt" download class="md-button">Download BiG-SCAPE barchart</a>
